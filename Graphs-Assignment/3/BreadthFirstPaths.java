...
public class BreadthFirstPaths {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        System.out.print("Enter place to travel through: ");
        String through = in.nextLine();
        in.close();
        ...
        int mid = sg.indexOf(through);
        int end = sg.indexOf(to);

        BreadthFirstPaths bfpStartToMid = new BreadthFirstPaths(G, start);
        BreadthFirstPaths bfpMidToEnd = new BreadthFirstPaths(G, mid);

        if(bfpStartToMid.hasPathTo(mid) && bfpMidToEnd.hasPathTo(end)){
            System.out.println("\n" + sg.nameOf(start) + " to " + sg.nameOf(end) + " going through " + sg.nameOf(mid));

            for(int x : bfpStartToMid.pathTo(mid)) System.out.println("- " + sg.nameOf(x));
            for(int x : bfpMidToEnd.pathTo(end)){
                if(!(x == mid)){
            ...
            System.out.println(sg.nameOf(start) + " to " + sg.nameOf(end) + "through" + sg.nameOf(mid) + " are not connected ");
        }
